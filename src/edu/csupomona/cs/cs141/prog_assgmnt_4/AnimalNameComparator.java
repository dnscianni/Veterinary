...
/**
 * This object is a comparator, that will compare Animals by their name. It will
 * order the names alphabetically, and will place any nulls to the end of the
 * list.
 * 
...
public class AnimalNameComparator implements Comparator<Animal> {
	...
	public int compare(Animal anim1, Animal anim2) {
		...
		if (anim1 != null && anim2 != null) {
			return anim1.getName().compareToIgnoreCase(anim2.getName());
		} else {
			return 1;
		}
	}
